...
//#region app/pages/accessories/index.vue?vue&type=script&setup=true&lang.ts
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "index",
	__ssrInlineRender: true,
	setup(__props) {
		useHead$1({
			title: "Accessories - Nairobi Powerbikes",
			meta: [{
				name: "description",
				content: "Shop premium motorcycle accessories in Nairobi. Helmets, gloves, covers, and more."
			}]
		});
		const pb = usePB();
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(motion).div, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<h1 class="font-heading text-4xl text-white sm:text-5xl lg:text-display-xl"${_scopeId}>Accessories</h1><div class="mt-2 h-1 w-24 bg-brand-red"${_scopeId}></div><p class="mt-4 text-brand-grey"${_scopeId}>Gear up with premium motorcycle accessories.</p>`);
					else return [
						createVNode("h1", { class: "font-heading text-4xl text-white sm:text-5xl lg:text-display-xl" }, "Accessories"),
						createVNode("div", { class: "mt-2 h-1 w-24 bg-brand-red" }),
						createVNode("p", { class: "mt-4 text-brand-grey" }, "Gear up with premium motorcycle accessories.")
					];
				}),
				_: 1
			}, _parent));
			...
			if (unref(loading)) {
				...
				ssrRenderList(8, (i) => {
					_push(`<div class="animate-pulse rounded-sm border border-brand-grey/10 p-4"><div class="aspect-square w-full rounded-sm bg-brand-grey/10"></div><div class="mt-4 h-5 w-3/4 rounded bg-brand-grey/10"></div><div class="mt-2 h-4 w-1/2 rounded bg-brand-grey/10"></div></div>`);
				});
				_push(`<!--]--></div>`);
					...
					_push(ssrRenderComponent(_component_NuxtLink, {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(ssrRenderComponent(unref(motion).div, {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) {
										_push(`<div class="aspect-square overflow-hidden bg-brand-black"${_scopeId}>`);
									...
									} else return [createVNode("div", { class: "aspect-square overflow-hidden bg-brand-black" }, [item.image ? (openBlock(), createBlock("img", {
										key: 0,
								...
								default: withCtx(() => [createVNode("div", { class: "aspect-square overflow-hidden bg-brand-black" }, [item.image ? (openBlock(), createBlock("img", {
									key: 0,
									src: unref(pb).files.getURL(item, item.image),
									alt: item.name,
									class: "h-full w-full object-cover transition-all duration-500 group-hover:scale-105"
				...
				_push(`<!--]--></div>`);
			} else _push(`<div class="mt-10 rounded-sm border border-dashed border-brand-grey/20 p-16 text-center"><p class="font-display text-xl tracking-display text-brand-grey">No Accessories Found</p><p class="mt-2 text-sm text-brand-grey/60">Try selecting a different category</p></div>`);
			_push(`</div></div>`);
		};
	}
});
//#endregion
//#region app/pages/accessories/index.vue
var _sfc_setup = index_vue_vue_type_script_setup_true_lang_default.setup;
index_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/accessories/index.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var accessories_default = index_vue_vue_type_script_setup_true_lang_default;

export { accessories_default as default };
//# sourceMappingURL=accessories-BPe1DFcF.mjs.map
