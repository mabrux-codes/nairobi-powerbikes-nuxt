...
//#region app/pages/service/booking.vue?vue&type=script&setup=true&lang.ts
var booking_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "booking",
	__ssrInlineRender: true,
	setup(__props) {
		useHead$1({
			title: "Service Booking - Nairobi Powerbikes",
			meta: [{
				name: "description",
				content: "Schedule a service appointment at Nairobi Powerbikes. Our certified technicians will keep your ride in top condition."
			}]
		});
		const pb = usePB();
		...
		async function onDateChange(e) {
			...
			try {
				const res = await pb.collection("service_bookings").getList(1, 50, {
					filter: `preferred_date = "${date}" && type = "service"`,
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(motion).div, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<h1 class="font-heading text-4xl text-white sm:text-5xl lg:text-display-xl"${_scopeId}>Book a <span class="text-brand-red"${_scopeId}>Service</span></h1><div class="mt-2 h-1 w-24 bg-brand-red"${_scopeId}></div><p class="mt-4 text-brand-grey"${_scopeId}>Schedule your next service appointment with our certified technicians.</p>`);
					else return [
						createVNode("h1", { class: "font-heading text-4xl text-white sm:text-5xl lg:text-display-xl" }, [createTextVNode("Book a "), createVNode("span", { class: "text-brand-red" }, "Service")]),
						createVNode("div", { class: "mt-2 h-1 w-24 bg-brand-red" }),
						createVNode("p", { class: "mt-4 text-brand-grey" }, "Schedule your next service appointment with our certified technicians.")
					];
				}),
				_: 1
			}, _parent));
			_push(ssrRenderComponent(unref(motion).div, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="grid gap-5 sm:grid-cols-2"${_scopeId}><div${_scopeId}><label class="mb-1.5 block text-xs font-display tracking-display text-brand-grey uppercase"${_scopeId}>Bike Model</label>`);
						...
						_push(`</div><div${_scopeId}><label class="mb-1.5 block text-xs font-display tracking-display text-brand-grey uppercase"${_scopeId}>Service Type</label>`);
						...
						_push(`</div></div><div class="grid gap-5 sm:grid-cols-2"${_scopeId}><div${_scopeId}><label class="mb-1.5 block text-xs font-display tracking-display text-brand-grey uppercase"${_scopeId}>Preferred Date</label>`);
						...
						createVNode("div", { class: "grid gap-5 sm:grid-cols-2" }, [createVNode("div", null, [createVNode("label", { class: "mb-1.5 block text-xs font-display tracking-display text-brand-grey uppercase" }, "Bike Model"), createVNode(unref(Field), { name: "bikeModel" }, {
							default: withCtx(({ componentField, errorMessage }) => [createVNode("input", mergeProps(componentField, {
								type: "text",
								placeholder: "e.g. Kawasaki Ninja 650",
								class: ["input-field h-11", { "border-brand-red": errorMessage }]
							...
							_: 1
						})]), createVNode("div", null, [createVNode("label", { class: "mb-1.5 block text-xs font-display tracking-display text-brand-grey uppercase" }, "Service Type"), createVNode(unref(Field), { name: "serviceType" }, {
						...
						createVNode("button", {
							...
							key: 1,
							class: "h-5 w-5"
						})), createTextVNode(toDisplayString(unref(isSubmitting) ? "Booking..." : "Book Appointment"), 1)], 8, ["disabled"])
...
//#endregion
//#region app/pages/service/booking.vue
var _sfc_setup = booking_vue_vue_type_script_setup_true_lang_default.setup;
booking_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/service/booking.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var booking_default = booking_vue_vue_type_script_setup_true_lang_default;

export { booking_default as default };
//# sourceMappingURL=booking-CrWPL417.mjs.map
