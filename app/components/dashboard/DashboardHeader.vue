<template>
  <header class="h-16 bg-brand-black/80 backdrop-blur-sm border-b border-brand-grey/30 flex items-center justify-between px-4 lg:px-6 shrink-0">
    ...
    <div class="flex items-center gap-3">
      <button class="relative p-2 text-brand-grey hover:text-white transition-colors">
        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
        </svg>
        <span class="absolute -top-0.5 -right-0.5 w-4 h-4 bg-brand-red text-white text-[9px] font-bold flex items-center justify-center rounded-full">3</span>
      </button>
