<template>
  <div class="rounded-sm border border-brand-grey/20 bg-brand-black p-6 sm:p-8">
    <form @submit.prevent="submit" class="space-y-5">
      ...
      <button type="submit" :disabled="isSubmitting || (selectedDate && availableTimeSlots.length > 0 && availableTimeSlots.every(s => bookedTimes.has(s)))" class="btn-primary mt-2 w-full justify-center h-12 disabled:opacity-50">
