    ...
    <Teleport to="body">
      <div v-if="preview" class="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 p-4" @click.self="preview = null">
        <div class="relative max-h-full max-w-4xl">
          <img :src="fileUrl(preview.ride, preview.file)" class="max-h-[80vh] w-auto rounded-lg border border-brand-grey/30 object-contain" />
...
function rideRows(b: Ride) {
  const defs: [string, string[]][] = [
    ...
    ['Riding Experience', ['riding_experience', 'experience']],
